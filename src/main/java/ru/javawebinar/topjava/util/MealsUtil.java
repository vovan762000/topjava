...
public class MealsUtil {
    ...
    public static final List<Meal> adminMeals = Arrays.asList(
            new Meal(LocalDateTime.of(2022, Month.OCTOBER, 19, 10, 0), "Завтрак адимна", 500),
            new Meal(LocalDateTime.of(2022, Month.OCTOBER, 19, 14, 0), "Обед адимна", 500),
            new Meal(LocalDateTime.of(2022, Month.OCTOBER, 19, 19, 0), "Ужин адимна", 500)
    );
